...
template<typename P>
void ApplyFilter(ImageClass<P> & img_in, ImageClass<P> & img_out, int const myRank, int const nRanks) {
...
template void ApplyFilter<float>(ImageClass<float> & img_in, ImageClass<float> & img_out, int const myRank, int const nRanks);
template void ApplyFilter<png_byte>(ImageClass<png_byte> & img_in, ImageClass<png_byte> & img_out, int const myRank, int const nRanks);
